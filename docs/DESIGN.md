...
> Design notes for **marketplace-receipt-handoff** — a runnable python example that Typed Python service that sends a receipt when a marketplace seller hands off an order.
...
- **Feature code** — the actual task: marketplace-receipt.
